...
describe("getImageSourceAucklandLibraries", () => {
  it("returns the correct URL when provided with a reference", () => {
  ...
  it("returns null when the reference is null", () => {
...
describe("getImageSourceArchives", () => {
  it("returns an object with location and reference when both are provided", () => {
  ...
  it("returns null when both location and reference are null", () => {
...
describe("getImageSourceFamily", () => {
  it("returns the correct string when provided with a name", () => {
    const name = "Smith";
...
describe("getImageSourceNewspaper", () => {
  it("returns an object with formatted date and name when both name and date are provided", () => {
  ...
  it("returns null when both name and date are null", () => {
...
describe("getImageSourceBookPage", () => {
  it("returns formatted page string when page is provided", () => {
    const page = "123";
...
describe("getImageSourceBookAuthors", () => {
  it("returns an array of author objects when provided with an array of authors", () => {
    const authors = [
...
describe("getImageSourceBook", () => {
  ...
  it("returns an object with all book details when all parameters are provided", () => {
    const expectedResult = {
      authors,
      title,
      town,
  ...
  it("returns null when any of title, town, publisher, or year is null", () => {
    expect(
  ...
  it("returns an object without page when page is null but other parameters are provided", () => {
    const expectedResult = {
      authors,
      title,
      town,
...
describe("Image Source Functions", () => {
  describe("getImageSource", () => {
    it("returns an object with all sources when provided", () => {
    ...
    it("returns an object with nulls for all sources when none are provided", () => {
  ...
  describe("getImage", () => {
    it("returns an object with url and source when url is provided", () => {
